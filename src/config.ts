...
export const siteConfig: SiteConfig = {
	title: "Charon",
	subtitle: "Own website",
	siteURL: "https://charon0415.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	navbarTitle: {
		...
		icon: "assets/home/2.svg",
	},

	bangumi: {
		userId: "1189551", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Charon0415",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/405927049?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/charon0415",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/atar.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Charon",
	...
	links: [
		...
		},
		{
			...
			url: "https://codeberg.org/Charon0415",
		},
		{
			name: "steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/id/Charon0415/",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://charon0415.netlify.app/",
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "One & Only", // HTML格式的自定义页脚信息，例如备案号等，默认留空
